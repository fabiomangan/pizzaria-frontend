                ...
                <CardContent>
                    <form className="space-y-4" action={formAction}>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input type="text" id="name" name="name" placeholder="Digite seu nome" required minLength={3} className="text-white bg-app-card border border-app-border"/>
                        </div>
                        ...
                        <p className="text-center text-sm text-gray-100">Já tem uma conta? <Link href="/login" className="text-brand-primary font-semibold">Faça o login</Link></p>
